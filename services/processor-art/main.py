"""Cloud Functions service that processes Pub/Sub messages for art Discord commands.
...
logger, tracing = init_observability('discord-processor-art', app=None)


@cloud_event
@traced_function("processor_art_handler")
def processor_art_handler(cloud_event: CloudEvent):
    ...
    try:
        ...
        logger.error("Critical error in processor_art_handler", error=e, correlation_id=correlation_id)
        raise
